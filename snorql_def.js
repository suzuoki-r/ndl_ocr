...
//@version 2020-09-23, 2021-02-01 desc_uripats, 2021-02-28 label_union追加, 2021-08-19 proporder, 2021-11-11 hutime, 2021-12-24 jpcos, 2022-08-22 wgs84
var Snorqldef = {
	...
	home: {
		...
		desc_uripats: ["https://jpsearch.go.jp/(entity|data)"], // ["https://jpsearch.go.jp/(entity|data)", "https://ld.cultural.jp/data/"],	//always use describe link even if dlink prop
	...
	askex: {
		...
		pat2proc: {
			...
			//メディア芸術データベース2021-10-20
			"https://mediaarts-db.bunka.go.jp/id/": function(aex){
				aex.query_and_proc("MediaArtDB", ["mdb","mdbdata","mdbdev"], "describe <" + aex.tguri + ">", "https://mediag.bunka.go.jp/sparql", null, false);
				return true;
			},
			//HuTime 2021-11-11
			"http://datetime.hutime.org/": function(aex){
				//"+?out=rdf/json" is to append format parameter to the uri
				aex.get_and_proc("HuTime", ["hutime"], "json", false, "+?out=rdf/json", true);
				return true;
			},
			//jp-cos 2021-12-24
			"https://w3id.org/jp-cos/": function(aex){
				aex.distill_and_proc("Jp-cos", ["jpcos"], true);
				return true;
			}
		},
		...
		exns: {
			...
			"mdb": "https://mediaarts-db.bunka.go.jp/data/property/",
			"mdbdata": "https://mediaarts-db.bunka.go.jp/data/property-data/",
			"mdbdev": "https://mediaarts-db.bunka.go.jp/data/property-dev/",
			"hutime": "http://resource.hutime.org/ontology/",
			"jpcos": "https://w3id.org/jp-cos/"
		}
	}
